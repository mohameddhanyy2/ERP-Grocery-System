    ...
    <div>
      ...
      {charts && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          {/* Revenue by store */}
          <div className="card">
            <h3 className="text-sm font-semibold text-gray-300 mb-4">Revenue by Store</h3>
            <ResponsiveContainer width="100%" height={200}>
          ...
          <div className="card flex flex-col gap-4">
            <h3 className="text-sm font-semibold text-gray-300">Finance Summary — {summary.period}</h3>
            {[
              { label: 'Revenue',  value: summary.periodRevenue,  color: 'text-emerald-400' },
              { label: 'Expenses', value: summary.periodExpenses, color: 'text-amber-400' },
              { label: 'Profit',   value: summary.periodProfit,   color: summary.periodProfit >= 0 ? 'text-emerald-400' : 'text-red-400' },
            ].map(r => (
            ...
            <div className="border-t border-gray-800 pt-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-semibold text-white">{summary.totalOrders}</span>
              </div>
            </div>
          </div>
        </div>
